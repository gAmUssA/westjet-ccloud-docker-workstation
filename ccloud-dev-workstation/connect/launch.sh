...
bash /etc/confluent/docker/wait-for-it schema-registry:8081 --strict --timeout=60 -- \
    connect-standalone /etc/kafka-connect/kafka-connect.properties /etc/kafka/connector.properties